...
<section id="clients" className={`${styles.paddingY} ${styles.flexCenter} flex-col relative mt-20`}>
    ...
    <div className={` ${styles.padding} items-center flex flex-col m-3 w-[400px] h-[615px] plan-bg-white rounded-[20px] box-shadow`}>
        ...
        <div className={` ${styles.padding} items-center flex flex-col m-3 w-[400px] h-[650px] plan-bg rounded-[20px] box-shadow`}>
